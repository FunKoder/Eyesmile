...
<head>
    ...
    <?php include('../dental/includes/style-links.php'); ?>
    <title>Login</title>
</head>

<body style="background-color: #D7F1F6;">
    <div>
        <p><a href="logout.php" id="btn1" class="btn ms-2 p-2 rounded fw-semibold">Back to Home</a></p>
        <div class="container-lg bg-info mx-auto mb-4 rounded shadow">
            <div class="row d-flex align-items-end">
                <form class="col-md-7 p-5 bg-white rounded-start-2" action="" method="post">
                    ...
                    <img src="../dental/logo/EyeSmile_Horitzontal.png" alt="Client Logo" class="img-fluid">
                ...
                <div class="col-md-5 d-none d-md-block align-self-center justify-content-center ps-5">
                    <img src="../dental/icons/dentist.png" alt="dentist" class="img-fluid" id="im2">
                </div>
            </div>
        </div>
    </div>
