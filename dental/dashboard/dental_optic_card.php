<?php if ($user['user_type'] === 'Dental') : ?>
    <div class="container-fluid py-2">
        ...
        <div class="card bg-warning shadow-sm row d-flex flex-row">
            <div class="col-7 p-3">
                <div class="h1">0</div>
                <h5 class="card-title">Stocks</h5>
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" class="col-5 p-1" width="125" height="125" fill="currentColor" class="bi bi-dropbox" viewBox="0 0 16 16">
