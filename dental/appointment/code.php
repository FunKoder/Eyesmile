...
if(is_numeric($paraResult)){
    ...
    if($user['status'] == 200) {
        ...
        if($userDeleteRes){
            redirect('request.php','Appointment Deleted Successfully');
        }
    }else{
        redirect('request-view.php',$user['Something Went Wrong']);
    }
}else {
    redirect('request-view.php',$paraResult);
}
...
if (isset($_POST['appoint'])) {
    ...
    if ($result) {
        ...
        try {
            ...
            redirect('request.php', 'Email sent successfully');
        } catch (Exception $e) {
