...
if (isset($_POST['saveUser'])) {
    ...
    $pass = password_hash(validate($_POST['pass']), PASSWORD_DEFAULT); // Hash the password
...
if(is_numeric($paraResult)){
    ...
    if($user['status'] == 200) {
        ...
        if($userDeleteRes){
            redirect('users.php','Appointment Deleted Successfully');
        }
    }else{
        redirect('users-create.php',$user['Something Went Wrong']);
    }
}else {
    redirect('users-create.php',$paraResult);
}
?>